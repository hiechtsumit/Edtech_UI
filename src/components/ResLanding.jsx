    ...
    <div className="min-h-[80vh] bg-pink-white font-sans flex flex-col justify-between">
      <nav className="flex flex-wrap justify-around items-center p-4">
        ...
        <div
          ...
          } md:flex space-x-2 md:mt-0`}
        >
          <button className="px-4 py-2 text-green-white font-semibold">
            Login
          </button>
      ...
      <main className="flex flex-col md:flex-row items-center justify-around gap-10 mt-10 md:mt-20 h-[100%] w-[100%]">
        <div className="max-w-lg md:text-left">
          <p className="text-green-white font-semibold mb-6 md:mb-10">
            Welcome
          </p>
          ...
          <p className="mb-6">
            Our goal is to make online <br className="hidden md:inline" />{" "}
            education work for everyone
          </p>
          <div className="space-x-4">
            <button className="px-6 py-2 bg-green-white text-white rounded-md">
              Join Us
            </button>
            <button className="px-6 py-2 border border-green-500 text-green-white rounded-md">
              Learn More
            </button>
          </div>
        </div>
        <div className="BOX-SGADOW md:mt-0">
          <img
            src="https://static.vecteezy.com/system/resources/thumbnails/026/991/883/small_2x/happy-school-girl-isolated-png.png"
            alt="Student"
            className="Box-Shadow z-10 w-auto h-[60vh] object-cover drop-shadow-2xl"
          />
        </div>
      </main>
    </div>
